...
ALTER TABLE `tracked_product_observations` ADD CONSTRAINT `tracked_product_observations_tracked_product_id_tracked_products_id_fk` FOREIGN KEY (`tracked_product_id`) REFERENCES `tracked_products`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
